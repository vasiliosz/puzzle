...
from puzzle.plugins import FamilyPlugin

# This should be a vcf with multiple families
FAMILY_VCF = "tests/fixtures/hapmap.vcf"
FAMILY_PED = "tests/fixtures/hapmap.ped"
...
class MockApp(object):
    ...
    def __init__(self):
        ...
        self.config = {
            'PUZZLE_ROOT': FAMILY_VCF,
            'FAMILY_FILE': FAMILY_PED,
            'FAMILY_TYPE': 'ped'
            }
        


class TestFamilyAdapter(object):
    ...
    def setup(self):
        ...
        self.adapter = FamilyPlugin()
        self.adapter.init_app(app)
        
    def test_family_individuals(self):
